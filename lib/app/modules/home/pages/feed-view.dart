...
class FeedView extends GetView<HomeController> {
  ...
  Widget renderLinkPreview(String link, bool total, Video video) {
    ...
    String provider = nomeServer(link),
        videoID = idVideo(link);
    var htmlDataVimeo =
    ...
    ? total
         ? EasyWebView(
       src: "https://www.facebook.com/plugins/video.php?href=https%3A%2F%2Fwww.facebook.com%2F164841987800427%2Fvideos%2F$videoID%2F&show_text=0&width=$width",
       onLoaded: () {},
       height: height,
       width: width,
       widgetsTextSelectable: true,
